export const title = 'Add Reading Time Estimates to Your Next.js Blog'
export const description = 'Learn how to add a reading time estimate to your  Next.js blog posts.'
export const date = '2023-11-29'
export const modified = '2023-12-08'
export const tags = ['nextjs','webdev','react','seo','blog']
